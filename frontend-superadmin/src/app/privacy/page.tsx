...
export const metadata: Metadata = {
  ...
  description:
    "Read the tstplotconnect privacy policy for details on data collection, account information handling, cookies, and user rights.",
  ...
  openGraph: {
    title: "Privacy Policy | tstplotconnect",
    description:
      "Understand how tstplotconnect collects, uses, and protects user information.",
    url: "/privacy",
    type: "website",
  ...
  twitter: {
    ...
    title: "Privacy Policy | tstplotconnect",
    description: "Review tstplotconnect's privacy and data handling policy."
  }
};
...
export default function PrivacyPage() {
  const schema = {
    ...
    "@type": "WebPage",
    name: "tstplotconnect Privacy Policy",
    url: "https://www.tst-plotconnect.com/privacy",
    description: "Privacy policy page for tstplotconnect users.",
    inLanguage: "en"
  };
    ...
    <main className="container" style={{ padding: "2rem 0 3rem" }}>
      <section className="card" style={{ padding: "1.2rem" }}>
        ...
        <p className="meta" style={{ margin: 0 }}>
          This policy explains what information tstplotconnect collects and how it is used to provide listing and account services.
        </p>
      </section>
