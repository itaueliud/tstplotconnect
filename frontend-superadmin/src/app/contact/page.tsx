...
export const metadata: Metadata = {
  ...
  description:
    "Contact tstplotconnect for listing support, account help, payment guidance, WhatsApp support, and partnership inquiries across Kenya.",
  alternates: { canonical: "/contact" },
  keywords: [
    "Contact tstplotconnect",
    "tstplotconnect support",
    "listing support Kenya",
    "WhatsApp tstplotconnect",
  ...
  openGraph: {
    title: "Contact tstplotconnect",
    description: "Reach tstplotconnect for support, listings help, and partnership inquiries.",
    url: "/contact",
    type: "website",
  ...
  twitter: {
    ...
    title: "Contact tstplotconnect",
    description: "Official support contacts for tstplotconnect."
  }
};
  ...
  const schema = [
    {
      ...
      "@type": "ContactPage",
      name: "Contact tstplotconnect",
      url: "https://www.tst-plotconnect.com/contact",
      description: "Official contact page for tstplotconnect support, partnerships, and user assistance.",
      inLanguage: "en-KE"
    },
    {
      "@context": "https://schema.org",
      "@type": "LocalBusiness",
      name: "tstplotconnect",
      description: "tstplotconnect helps people discover verified hostels, bedsitters, lodges, apartments, and plots across Kenya.",
  ...
  return (
    <AuthenticatedUserShell active="contact">
      <section className="card" style={{ padding: "1.4rem", background: "linear-gradient(135deg, rgba(7,17,30,0.96), rgba(13,88,122,0.86))", color: "#fff" }}>
        <span className="pill">Contact tstplotconnect</span>
        ...
        <p style={{ margin: 0, maxWidth: 760, color: "rgba(236,245,255,0.86)", lineHeight: 1.8 }}>
          We support account access issues, listing questions, payment guidance, and general help through official tstplotconnect channels.
        </p>
      </section>
      ...
      <section className="card" style={{ marginTop: "1rem" }}>
        ...
        <div style={{ display: "flex", gap: "0.7rem", flexWrap: "wrap" }}>
          <a className="btn btn-primary" href="mailto:support@tst-plotconnect.com?subject=Support%20Request%20-%20tstplotconnect">Email Support</a>
