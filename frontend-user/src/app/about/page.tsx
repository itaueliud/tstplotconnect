...
export const metadata: Metadata = {
  title: "About tstplotconnect",
  description:
    "Learn how tstplotconnect helps renters, students, and travelers discover verified hostels, lodges, bedsitters, apartments, and plots across Kenya.",
  ...
  openGraph: {
    title: "About tstplotconnect",
    description: "Discover the mission, service focus, and trust model behind tstplotconnect.",
    url: "/about",
    type: "website",
  ...
  twitter: {
    ...
    title: "About tstplotconnect",
    description: "Learn what tstplotconnect offers and how it helps people find trusted listings."
  }
};
...
export default function AboutPage() {
  const schema = {
    ...
    "@type": "AboutPage",
    name: "About tstplotconnect",
    url: "https://www.tst-plotconnect.com/about",
    description:
      "About page describing tstplotconnect's mission, service areas, and trusted property discovery approach.",
    inLanguage: "en-KE"
  };
  ...
  return (
    <AuthenticatedUserShell active="about">
      <section className="card" style={{ padding: "1.4rem", background: "linear-gradient(135deg, rgba(7,17,30,0.96), rgba(15,118,110,0.82))", color: "#fff" }}>
        <span className="pill">About tstplotconnect</span>
        ...
        <p style={{ margin: 0, maxWidth: 760, color: "rgba(236,245,255,0.86)", lineHeight: 1.8 }}>
          tstplotconnect helps renters, students, travelers, and short-stay customers discover trusted hostels, bedsitters,
      ...
      <section className="grid" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", marginTop: "1rem" }}>
        ...
        <article className="card">
          ...
          <p className="meta" style={{ margin: 0 }}>
            tstplotconnect is built for people looking for everyday rentals, temporary stays, and local accommodation opportunities across active Kenyan markets.
          </p>
        </article>
        <article className="card">
      ...
      <section className="card" style={{ marginTop: "1rem" }}>
        <h2 style={{ marginTop: 0 }}>What makes tstplotconnect useful</h2>
      ...
      <section className="card" style={{ marginTop: "1rem" }}>
        ...
        <p className="meta" style={{ marginTop: 0 }}>
          For support, listing guidance, activation help, or partnership inquiries, use the official tstplotconnect contact channels.
        </p>
